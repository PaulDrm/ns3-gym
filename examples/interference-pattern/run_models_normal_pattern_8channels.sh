...
models=("meta-llama/Meta-Llama-3-8B-Instruct") #meta-llama/Llama-2-7b-chat-hf" "microsoft/phi-2" "microsoft/Phi-3-mini-4k-instruct" "meta-llama/Llama-2-7b-chat-hf" 
#models=("openchat/openchat-3.5-0106")
output_path="./results/paper/greedy_sampler_agent_normal_pattern_8channels.json"
