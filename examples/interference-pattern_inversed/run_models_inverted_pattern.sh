...
models=("microsoft/phi-2" "microsoft/Phi-3-mini-4k-instruct" "meta-llama/Llama-2-7b-chat-hf" "meta-llama/Meta-Llama-3-8B-Instruct") #"microsoft/phi-2" "microsoft/Phi-3-mini-4k-instruct" "meta-llama/Llama-2-7b-chat-hf" 
#models=("openchat/openchat-3.5-0106")
#output_path="./llama3_greedy_sampler_agent_noise_reasoning.json"
output_path="./greedy_sampler_agent_normal_pattern_full.json"
output_path="./greedy_sampler_agent_inverted_pattern_full.json"
